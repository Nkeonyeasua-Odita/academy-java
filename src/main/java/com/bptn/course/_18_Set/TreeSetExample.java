...
public class TreeSetExample {
	...
	public static void main(String[] args) {
		...
		treeSet.remove(20);// youre removing the element 20 in the list
		...
		System.out.println("Elements in the headSet: " + treeSet.headSet(30));// strictly values lower than 30??

		// Get the tailSet from the TreeSet
		System.out.println("Elements in the tailSet: " + treeSet.tailSet(30));// 30 and greater
		...
		NavigableSet<Integer> descendingSet = treeSet.descendingSet();// use to reverse??
