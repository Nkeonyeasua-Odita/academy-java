...
public class LeapYearTest {
	...
	public void testLeapYear() {
		...
		// assertTrue()
		assertTrue(actualResult == expectedResult);// this is manually comparing the two variables using ==
		// If actualResult equals expectedResult, the test passes

		// assertTrue(expectedResult, actualResult);//wrong
