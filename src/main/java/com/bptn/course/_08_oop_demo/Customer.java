...
class Customer {
	...
	public Customer(String customerID, String customerName, String customerEmail) {
		...
		// lefthand side referencing the customer id coming from the user
		this.customerID = customerID;
		this.customerName = customerName;
		this.customerEmail = customerEmail;
		this.cart = new ShoppingCart();// when you create a new customer they have a new/ their own cart
	}
