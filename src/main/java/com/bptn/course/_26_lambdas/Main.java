package com.bptn.course._26_lambdas;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// System.out.println("testing for num1 " + num1);
		num1 = () -> 21 * 2;
		...
		// Note that you can return whatever you want–as long as it matches the return
		...
		// this line wouldnt run because the method takes 2 int parameters and not
		// double
